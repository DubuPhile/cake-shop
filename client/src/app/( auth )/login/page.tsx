...
export default function login() {
  ...
  const [verOtp] = useVerifyOTPMutation();
    ...
    <div className="flex items-center justify-center">
      <div className="w-screen flex items-center h-screen justify-center max-w-300">
        {/* <div className="hidden md:flex w-[60%] items-center justify-center">
          <div className="w-full m-5 h-125 bg-blue-200 rounded-2xl drop-shadow-lg">
            <h1>Ads Sectiondsadsadasdsadasdasdsadsadasdasdasdasdas</h1>
          </div>
        </div> */}
            ...
            {isLoading ? (
              ...
              <>
                ...
                {errMsg && (
                  <p
                    ref={errorRef}
                    className="mx-3 my-1 text-base text-red-500"
                  >
                    {errMsg}
                  </p>
                )}
